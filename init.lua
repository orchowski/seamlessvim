...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gtR', vim.lsp.buf.rename, '[R]e[n]ame')
  ...
  { 'caglartoklu/borlandp.vim', name = 'borlandp', priority = 1000 },
  {
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    main = 'nvim-treesitter', -- Treesitter now exposes setup via `nvim-treesitter`
  ...
  --
  -- require 'kickstart.plugins.debug', // i have my own, custom one
  require 'kickstart.plugins.indent_line',
  require 'kickstart.plugins.lint',
  require 'kickstart.plugins.autopairs',
  -- require 'kickstart.plugins.neo-tree', // i have my own
